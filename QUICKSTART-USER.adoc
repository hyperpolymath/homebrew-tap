...
// Replace homebrew-tap, Homebrew Tap — See README.adoc for details., just run, Homebrew Tap started successfully. with actuals
= homebrew-tap — Quick Start for Users
:toc:
:toclevels: 2

== What is homebrew-tap?

Homebrew Tap — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./homebrew-tap-portable
----
...
[source]
----
Homebrew Tap started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/homebrew-tap/wiki
