...
doctor:
    @echo "Running diagnostics for homebrew-tap..."
...
help-me:
    @echo "=== homebrew-tap Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/homebrew-tap/issues/new"
    @echo ""
